return (ASS, ASSFInst, yutilsMissingMsg, createASSClass, Functional, LineCollection, Line, logger, SubInspector, Yutils) ->
  ...
  DrawingBase.parse = (str, parent, splitContours = true) ->
  ...
  DrawingBase.new = (args = {}) =>
    unless cmdMap
      cmdMap, cmdSet, Close, Move, Contour, Bezier = ASS.Draw.commandMapping, ASS.Draw.commands, ASS.Draw.Close, ASS.Draw.Move, ASS.Draw.Contour, ASS.Draw.Bezier
    ...
    if args.raw or args.str
      ...
      @contours, @junk = DrawingBase.parse str, @, args.splitContours
